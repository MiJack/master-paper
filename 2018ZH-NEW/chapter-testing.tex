...
为了验证本文提出的测试框架对性能测试的有效性。基于已实现的框架，本章首先验证了自动化遍历能否有效的发现App更多的状态。其次我们验证本框架中能否结合Activity和Fragment的运行信息，有效发现帧数丢失问题。最后我们通过对实验中发现性能问题的App源码进行了静态分析，验证本文提出方法的有效性。
考虑到本工具依赖程序的源码，我们使用了开放源代码的App进行实验。因此，在本工作中，我们可以进一步的定位性能问题，佐证工具的有效性。
