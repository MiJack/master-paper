...
\renewcommand{\listtablename}{\hfill\bfseries\Large 表格清单\hfill} 
\renewcommand{\listfigurename}{\hfill\bfseries\Large 插图清单\hfill} 


\renewcommand{\listalgorithmcfname}{\centering\bfseries\Large 算法清单}
