...
在应用程序运行时，点击按钮button1，应用会计算斐波拉契数列中的第4项，并将这个数以Toast的形式展示给用户。
...
其次，方法\code{Toast.makeText(Context,CharSequence,int)}没有出现在RunDroid的结果中，却出现在FlowDroid给出的结果：
...
\begin{table*}[!ht]
	\centering
	{
		...
		\begin{tabular}{ |c |c|c|c|c|c|c|c|}
			\hline
		\multirow{3}*{序号 }& \multirow{3}*{应用 }& \multirow{3}*{用户方法 }  & \multirow{3}*{系统方法} &\multirow{3}{1.3cm}{\centering 函数调用关系}& \multicolumn{3}{c|}{函数触发关系} \\ 
			\cline{6-8}	
		...
		%	1 &   & 19 & 27（118）& 21 & 3& 1& 1/114& ~ \\ 	
			...
			\hline			
			1 &AnyMemo & 1021 & 322(2731) & 1105(3487)& 3& 0& 35(425) \\ 				
			\hline	
			2 &archwiki-viewer & 3699 & 3504 & 310(3342)& 0& 0& 680(21332) \\ 				
			\hline	
			3 &chanu & 1086& 353(3917) & 397(4817)& 0& 1& 33(43439) \\ 				
			\hline	
			4 &Microphone & 31 & 230(1531) & 161(1334)&4& 6&21 (261)\\ 				
			\hline	
			5 &osmtracker-android & 997& 328(2483) & 1162(2453)& 0& 0& 3(368) \\ 				
			\hline	
			6 &Quran For My Android & 156 & 204(3930) & (3831)& 5& 2+2& 26(655) \\ 				
			\hline	
			7 &ReGeX & 1415 &95 (987) & 1323(2311)& 0& 4& 35(166)\\ 				
			\hline	
			8 &screenrecorder& 1301 & 320(3278) &879 (4539)& 1& 2& 4(24863)\\ 				
			\hline	
			9 &upm-android & 118& 337( 3097)& 355(2918)& 2& 0+4& 19(489) \\ 		
			\hline
		\end{tabular}
	}
\end{table*}
