...
通过观察虚线框中各节点的关系，我们知道，对于方法\code{doFibonacci()}，当参数为4时，对应的结果为5。
...
\begin{table*}[!ht]
	\centering
	{
		...
		\begin{tabular}{ |c |c|c|c|c|c|c|c|}
			\hline
		\multirow{3}*{序号 }& \multirow{3}*{应用 }& \multirow{3}*{用户方法 }  & \multirow{3}*{系统方法} &\multirow{3}*{\centering 函数调用关系总数}& \multicolumn{3}{c|}{函数触发关系} \\ 
			\cline{6-8}	
