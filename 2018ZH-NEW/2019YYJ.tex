...
\renewcommand{\listtablename}{\hfill\bfseries\Large 表~格~清~单\hfill} 
\renewcommand{\listfigurename}{\hfill\bfseries\Large 插~图~清~单\hfill} 


\renewcommand{\listalgorithmcfname}{\centering\bfseries\Large 算~法~清~单}
...
\newcommand{\TheisNameEn}[0]{ Building Android Dynamic Call Graph: \\ Design and Implement of RunDroid}
