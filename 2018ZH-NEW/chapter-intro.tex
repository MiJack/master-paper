...
AppAudit\cite{xia2015effective}

Inspeckage\cite{acpmInsp34}



另外，研究人员还用动态分析技术查找Android应用程序在运行时性能瓶颈。
通过方法执行时间的长短和执行路径，开发人员可以发现程序的性能瓶颈，进而通过对程序代码做出调整，提升程序的运行性能。
...
marvin \cite{lindorfer2015marvin}
