...
这方面相关工具包括[\citenum{vallee1999soot,arzt2014flowdroid,AmanDroid,iccta,androguard:online,pxb1988d85,javadeco45,iBotPeac46,maaaazan93}]。
...
这方面的工作代表包括[\citenum{chun2014taintdroid,droidbox:online,van2013dynamic,droidscope}]等。
...
\todo{工作[\citenum{azim2013targeted}]利用静态分析工具SCanDroid得到静态Activity迁移图，并结合基于目标探索策略和深度优先探索策略进而达到了较好的Activity覆盖率。
